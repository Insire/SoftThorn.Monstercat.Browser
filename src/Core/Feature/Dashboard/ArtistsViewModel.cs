...
namespace SoftThorn.Monstercat.Browser.Core
{
    ...
    public sealed class ArtistsViewModel : ObservableRecipient, IDisposable
    {
        ...
        public ArtistsViewModel(IScheduler scheduler, ITrackRepository trackRepository, IMessenger messenger)
            : base(messenger)
        {
            ...
            Messenger.Register<ArtistsViewModel, SettingsChangedMessage>(this, (r, m) =>
            {
                ...
                r._subscription = CreateSubscription(m.Value.ArtistsCount);
            });
